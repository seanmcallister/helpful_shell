...
##Run concoct
echo
echo "Starting chaos with concoct..."
echo "Warning: Anaconda2 python path must be moved for concoct to work so should not run programs requiring python at the same time as this script."
echo
mv /home/mcallis/software/python-versions/anaconda2 /home/mcallis/software/
...
source deactivate
mv /home/mcallis/software/anaconda2 /home/mcallis/software/python-versions/
...
sleep 10s
echo
echo "CONCOCT chaos over..."
echo

##Run Binsanity
#Note: for some stupid reason I can only get checkm to work while ssh'ed into biomix16, not through qsub...
echo
